...
module.exports = {
    VERSION: 'V 2.0.1',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/KCnoMM2.jpg مرحبا{sender}, انا اونلاين \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;ayoub;212617076646;https://i.imgur.com/st4R2dq.jpeg;https://chat.whatsapp.com/ELS0hv0Sfgz9CdOSYBQ5UM',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'ayoub',
    ...
    SUDO: process.env.SUDO || '212617076646,0',
